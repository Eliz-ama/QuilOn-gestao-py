...
select_image_button = tk.Button(window, text="Selecione uma imagem", command=select_image, bg = "#F6AA1C", font =("Helvetica 10" ))
select_image_button.pack()
select_image_button.place(relx = .50, rely = .70, anchor = "n")

# create the rotate image button
rotate_button = tk.Button(window, text="Rotacione", command=rotate_image_handler, bg = "#F6AA1C", font =("Helvetica 10" ))
rotate_button.pack()
rotate_button.place(relx = .30, rely = .70, anchor = "n")

#botao de prosseguir
btn_proximo = tk.Button(window,text="Próximo",bg="#F6AA1C",command=lambda:proximo())
